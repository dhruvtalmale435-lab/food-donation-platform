...
function setupRoleNavbar() {
  ...
  if (!existingProfile) {
    ...
    profileLi.innerHTML = `<a href="profile.html" style="display:flex;align-items:center;gap:5px;"><span style="font-size:18px;">👤</span> Profile</a>`;
  ...
  if (!existingMap) {
    ...
    mapLi.id = "navLiveMap";
    mapLi.innerHTML = `<a href="live-tracking.html" style="display:flex;align-items:center;gap:5px;"><span style="font-size:18px;">📍</span> Live Map</a>`;
